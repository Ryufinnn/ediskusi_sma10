...
<center class="style3"><align="center">Diskusi Seputar Latihan Sekolah
</center><br>
...
<form name="form1" method="post" action="simpan_coment_latihan.php">
  <table width="500" border="0" cellspacing="2" cellpadding="0" class="keliling">
    ...
    <tr> 
      ...
      <td><input name="txttelp" type="text" size="35" maxlength="40" value="Latihan" ></td>
    </tr>
...
<?php
  ...
  ?>
  <?php
  $sql = "SELECT * FROM pesan WHERE telp LIKE '%Latihan%' ";
  $qry = mysql_query($sql);
