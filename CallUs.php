...
<center class="style3"><align="center">Diskusi Seputar Tugas Sekolah
</center><br>
...
<form name="form1" method="post" action="simpan_coment.php">
  <table width="500" border="0" cellspacing="2" cellpadding="0" class="keliling">
    ...
    <tr> 
      ...
      <td><input name="txttelp" type="text" size="35" maxlength="40" value="Tugas" ></td>
    </tr>
...
<?php
  ...
  ?>
  <?php
  $sql = "SELECT * FROM pesan WHERE telp LIKE '%Tugas%' ";
  $qry = mysql_query($sql);
